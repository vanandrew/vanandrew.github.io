      ...
      <div className="container-custom relative z-10">
        ...
        <div className="grid md:grid-cols-12 gap-16">
          ...
          <div className="md:col-span-4 md:col-start-2">
            <h3 className="text-lg font-light mb-6 relative inline-block">
              Andrew Van
            </h3>
            <p className="text-mono-gray text-sm mb-8 leading-relaxed max-w-xs">
        ...
        <div className="border-t border-mono-lightgray mt-16 pt-8 text-center">
          <p className="text-mono-gray text-sm">© {new Date().getFullYear()} Andrew Van. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
