    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="pt-32 py-24 bg-mono-white">
        <div className="container-custom">
          <h2 className="text-3xl font-medium mb-16 text-center text-mono-black">About Me</h2>
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="mt-8">
                <h3 className="text-xl font-medium mb-4 text-mono-black">My Skills</h3>
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <span key={skill} className="bg-mono-offwhite border border-mono-lightgray text-mono-black px-3 py-1 rounded-full text-sm">
                      {skill}
                    </span>
                  ))}
                </div>
            ...
            <div className="space-y-6">
              <div className="border border-mono-lightgray p-6 mb-6">
                <h3 className="text-xl font-medium mb-3 text-mono-black">Education</h3>
                <div className="mb-4">
                  <p className="text-mono-black">Doctor of Philosophy in Biomedical Engineering</p>
                  <p className="text-mono-gray text-sm">Washington University in St. Louis, 2023 (GPA: 3.94)</p>
                </div>
                <div>
                  <p className="text-mono-black">Bachelor of Science in Biomedical Engineering</p>
                  <p className="text-mono-gray text-sm">Texas A&M University, 2014 (GPA: 3.8)</p>
                </div>
              </div>
              <div className="border border-mono-lightgray p-6">
                <h3 className="text-xl font-medium mb-3 text-mono-black">Experience</h3>
                <div className="mb-4">
                  <p className="text-mono-black">Senior Machine Learning Scientist</p>
                  <p className="text-mono-gray text-sm">Turing Medical, March 2025 - Present</p>
                </div>
                <div className="mb-4">
                  <p className="text-mono-black">Machine Learning Scientist</p>
                  <p className="text-mono-gray text-sm">Turing Medical, November 2023 - March 2025</p>
                </div>
                <div className="mb-4">
                  <p className="text-mono-black">Visiting Scholar</p>
                  <p className="text-mono-gray text-sm">University of Pennsylvania Perelman School of Medicine, June 2023 - August 2023</p>
                </div>
                <div className="mb-4">
                  <p className="text-mono-black">Ph.D. Candidate in Biomedical Engineering</p>
                  <p className="text-mono-gray text-sm">Washington University in St. Louis, August 2018 - November 2023</p>
                </div>
                <div className="mb-4">
                  <p className="text-mono-black">Neuro Imaging Research Technician</p>
                  <p className="text-mono-gray text-sm">Washington University School of Medicine, August 2016 - August 2018</p>
                </div>
                <div>
                  <p className="text-mono-black">Research Assistant</p>
                  <p className="text-mono-gray text-sm">Texas A&M University, January 2012 - May 2014</p>
                </div>
              </div>
            </div>
          </div>
